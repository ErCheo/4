...
3. Система отображает список моек в выбранном городе (UC3.1.1)
4. Пользователь выбирает мойку
5. Система отображает список услуг (UC3.2)
6. Пользователь выбирает нужные ему услуги
7. Система отображает свободные даты и время (UC3.3)
8. Пользователь выбирает дату и время
9. Система отображает сообщение об успешной записи на мойку
10. Система сохраняет данные о записи в базу данных
...
Альтернативный сценарий:
	- Система сообщает, что запись не может быть отменена 
	- Система предлагает пользователю обратить в тех поддержку для решения проблемы
